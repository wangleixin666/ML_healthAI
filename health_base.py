...
# 读取数据
part_1 = pd.read_csv('D:/kaggle/health/meinian_round1_data_part1_20180408.txt', sep='$')
part_2 = pd.read_csv('D:/kaggle/health/meinian_round1_data_part2_20180408.txt', sep='$')
...
tmp.to_csv('D:/kaggle/health/tmp.csv')
