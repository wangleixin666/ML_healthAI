...
table_id_group.to_csv(r'D:/kaggle/health/part_tabid_size.csv',encoding='utf-8')
...
merge_part1_2=pd.read_csv(r'D:/kaggle/health/merge_part1_2.csv',sep=',',encoding='utf-8')
...
merge_part1_2.to_csv(r'D:/kaggle/health/merge_part1_2.csv')
